...
\input{struct_plano_nutricional}
\chapter{Documentação do ficheiro}
\input{funcoes_8c}
\input{_gestao_ficheiros_8c}
\input{_gestao_ficheiros_8h}
\input{_gestao_ficheiros_8h_source}
\input{global_8h}
